...
public partial class GameEntity {
    ...
    public Gameplay.Game.Features.Position.Components.PositionComponent position { get { return (Gameplay.Game.Features.Position.Components.PositionComponent)GetComponent(GameComponentsLookup.Position); } }
    ...
    public void AddPosition(UnityEngine.Vector3 newValue) {
        ...
        var component = (Gameplay.Game.Features.Position.Components.PositionComponent)CreateComponent(index, typeof(Gameplay.Game.Features.Position.Components.PositionComponent));
